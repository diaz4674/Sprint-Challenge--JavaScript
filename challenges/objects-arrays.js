...
let tyrannosaurus = new dinosaur({name: 'tyrannosaurus', diet: 'carnivorous', weight: '7000kg', length: '12m', period: 'Late Cretaceious'});
...
let velociraptor = new dinosaur({name: 'velociraptor', diet: 'carnivorous', weight: '15kg', length: '1.8m', period: 'Late Cretaceious'});
...
const populationTotal = zooAnimals.reduce( (totalPop, curr) => {
  return totalPop + curr.population;
}, 0)
